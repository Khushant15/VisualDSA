...
const faqs = [
  {
    ...
    answer: "VisualDSA is an interactive web application designed to help users visualize and understand various sorting and searching algorithms in real-time.",
    keywords: [
      { word: "visualdsa", weight: 10 }, 
      { word: "about", weight: 5 },
  ...
  },
  {
    ...
    answer: "There is no need to run VisualDSA locally! The entire platform runs seamlessly in your web browser.",
    keywords: [
    ...
    answer: "Yes! VisualDSA is completely free to use.",
    keywords: [
      { word: "free", weight: 10 },
      { word: "cost", weight: 10 },
