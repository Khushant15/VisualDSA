...
const Footer = () => {
  ...
  return (
    <>
      <footer className={`footer-container glass-footer ${isVisible ? "visible" : ""}`}>
          ...
          >
            <div className="brand-header">
              <div className="logo-wrapper">
                ...
                />
                <span className="logo-text">VisualDSA</span>
              </div>
          ...
          <div className="bottom-content">
            <div className="footer-main-row">
              <div className="copyright">
                <p>&copy; {new Date().getFullYear()} VisualDSA. All rights reserved.</p>
              </div>
