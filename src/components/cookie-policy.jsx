...
const CookiePolicy = () => {
  ...
  const cookieSections = [
      ...
      additionalContent: (
        <div className="comparison-table">
          ...
          <div className="table-row">
            ...
            <div>Varies</div>
            <div>Set directly by VisualDSA</div>
          </div>
          <div className="table-row">
            <div>
    ...
    },
    {
      ...
      content:
        "By continuing to use VisualDSA, you consent to our use of cookies as described in this policy. You can withdraw consent at any time by adjusting your browser settings or contacting us.",
    },
    {
      id: "updates",
      icon: "🔄",
    ...
    >
      <div className="cookie-policy-content">
        ...
        <div className="cookie-policy-header">
          ...
          <h1>Cookie Policy</h1>
          <p className="effective-date">Last Updated: 1 May 2026</p>
