                ...
                <div className="av-container">
                    ...
                    <div className="logo">
                        <Link to="/" className="logo-link">
                            <div className="logo-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                                <img src="/logo.png" alt="VisualDSA Logo" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "6px" }} />
                            </div>
                            <h1 className="navbar-heading">
                                Visual<span className="highlight">DSA</span>
                            </h1>
                        </Link>
                    </div>
